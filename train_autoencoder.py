...
def main(unused_argv):
  ...
  dataset = tf.data.TFRecordDataset(join(FLAGS.dataset, 'trainset.tfrecords')).map(parse_function).prefetch(FLAGS.batch_size).shuffle(FLAGS.batch_size).batch(FLAGS.batch_size)
